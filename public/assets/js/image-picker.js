...
(function () {
  ...
  ImagePicker = (function () {
    function ImagePicker (select_element) {
      const opts1 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {}
    ...
    _createClass(ImagePicker, [{
      ...
      value: function recursively_parse_option_groups (scoped_dom, target_container) {
        let container, j, k, len, len1, option, option_group, ref, ref1, results
      ...
      value: function toggle (imagepicker_option, original_event) {
        let new_values, old_values, selected_value
  ...
  ImagePickerOption = (function () {
    function ImagePickerOption (option_element, picker) {
      const opts1 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {}
    ...
    _createClass(ImagePickerOption, [{
      ...
      value: function create_node () {
        let image, imgAlt, imgClass, thumbnail
        this.node = jQuery('<li/>')
